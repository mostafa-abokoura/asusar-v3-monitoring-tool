...
class Ui_MainWindow(object):        
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_2.addWidget(self.dataTable, 1, 0, 1, 7)
        ...
        self.gridLayout_2.addWidget(self.Search, 0, 6, 1, 1)
        ...
        self.comboBox.setMaximumSize(QtCore.QSize(250, 22))
    ...
    def t_checkForMsgs(self):
        while True:
            ...
            if msg:
                ...
                msg_ts, msg_ch, msg_id, msg_data = decode(rec_msg)
                try:
                    name = self.dbc.get_message_by_frame_id(int(msg_id.replace(' ', ''), 16)).name
                except KeyError:
                    name = "UNDEFINED"
                #name = getNameFromID(msg_id)
